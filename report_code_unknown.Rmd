...
cat("\\newline")
cat("Disclaimer: Due to differences between your local system and the app running on Shinyapps.io, the results generated locally by executing the folling code may be different to the PDF report. ")
```
