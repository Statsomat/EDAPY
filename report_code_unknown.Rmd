...
codechunk <- function(text, style=list(color="white")){
  cat(
    sprintf('<pre><code class="w" style="%s">%s</code></pre>', 
...
```{r, results="asis", eval = eval_code, echo = FALSE}
code1 <- "# Define the path to your data (please remark the forward slash
filepath = "
code <- paste0(code1, paste0("\"C:/",params$filename[1],"\""))
codechunk(code, style=list("border"="0", "background-color"="#FFFFFF"))
```
